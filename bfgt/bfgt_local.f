...
c
c
      subroutine g3d_tens_prod_to_potloc_blas(nd,n,fvals,pot,
     1    ntab,tab_loc,ind_loc,ixyz)
C*********************************************************************C
c     This routine computes 3D volume Gauss transform over a 
c     single box source distribution given as function values
...
c        transform in x
     ...
     1       tab_loc(1,1,ix),n,fv,n,beta,ff,n)

c        transform in y
         do j3=1,n
         do j2=1,n
         do k1=1,n
            fft(j2,j3,k1)=ff(k1,j2,j3)
         enddo
         enddo
         enddo

         call dgemm('t','n',n,n*n,n,alpha,
     1       tab_loc(1,1,iy),n,fft,n,beta,ff2t,n)

c        transform in z
         do j3=1,n
            do k2=1,n
               do k1=1,n
                  ff2(k1,k2,j3)=ff2t(k2,j3,k1)
               enddo
            enddo
         enddo

         call dgemm('n','n',n*n,n,n,alpha,
     1       ff2,n*n,tab_loc(1,1,iz),n,beta,dpot,n*n)
         
         do k3=1,n
         do k2=1,n
         do k1=1,n
            pot(ind,k1,k2,k3)=pot(ind,k1,k2,k3)+dpot(k1,k2,k3)
         enddo
         enddo
         enddo
c     end of the ind loop
...
c
      ...
      if (nx+ny+nz .ge. n) then
         call g3d_tens_prod_to_potloc_blas(nd,n,fvals,pot,
     1       ntab,tab_loc,ind_loc,ixyz)
         return
      endif
