...
c----------------------------------------------------------------
c      
      subroutine pfgt_find_pwexp_boxes_new(ndim,npwlevel,nboxes,
...
c
c
      subroutine pfgt_compute_listpw_new(ndim,npwlevel,nboxes,nlevels,
...
c
c
      subroutine compute_mnlist1_new(ndim,nboxes,nlevels,laddr,
     1    centers,boxsize,iparent,nchild,
     2    ichild,isep,nnbors,nbors,iper,mnlist1)
c     
      implicit none
...
c      
c      
      subroutine pfgt_compute_modified_list1_new(ndim,
     1    nboxes,nlevels,ltree,itree,iptr,centers,boxsize,iperiod,
     2    ifleafbox,npwlevel,isep,
     3    mnlist1,nlist1,list1)
c
c
c     This subroutine computes list 1 in the above subroutine.
c
c      
c      
c     INPUT arguments
...
c     Temp variables
      integer ilev,ibox,jbox,dad,mnbors,mc,jboxchild,nlevend
      ...
      nlevend = npwlevel
      if (npwlevel.ge.nlevels) nlevend=nlevels-1
