...
c     don't change the tree within fgt for now
      ifnewtree=0
c
c      call heat2d_am2(norder, nordert, finit, feval,
c     1     dt, ntot, eps, mxltree, mxboxes, mxlevels,
c     2     ltree, itree, iptr, centers, nlevels,
c     3     boxsize, nboxes, ifnewtree, usol)
c
      ifexact = 1
      ifexact = 0
     ...
     3     boxsize, nboxes, ifnewtree, ifexact, uexact,
     4     usol)
c
